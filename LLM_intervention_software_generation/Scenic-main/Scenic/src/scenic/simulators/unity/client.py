...
class JointAngles:
    ...
    # --- New fingertip position fields ---
    leftThumbTip: Vector
    leftIndexTip: Vector
    leftMiddleTip: Vector
    leftRingTip: Vector
    leftPinkyTip: Vector

    rightThumbTip: Vector
    rightIndexTip: Vector
    rightMiddleTip: Vector
    rightRingTip: Vector
    rightPinkyTip: Vector

    # --- New wrist position fields ---
    leftWristPos: Vector
    rightWristPos: Vector

    # --- New elbow position fields ---
    leftElbowPos: Vector
    rightElbowPos: Vector

    # --- New chest and headset position fields ---
    chestPos: Vector
    headsetPos: Vector

    # --- New adjacent-finger angle fields (left hand) ---
    leftThumbIndexAngle: float
    leftIndexMiddleAngle: float
    leftMiddleRingAngle: float
    leftRingPinkyAngle: float

    # --- New adjacent-finger angle fields (right hand) ---
    rightThumbIndexAngle: float
    rightIndexMiddleAngle: float
    rightMiddleRingAngle: float
    rightRingPinkyAngle: float
    ...
    def from_dict(obj: Any) -> 'JointAngles':
        ...
        return JointAngles(
            ...
            leftShoulderAbductionFlexion=from_float(obj.get("LeftShoulderAbductionFlexion")),
            leftHorizontalAbduction=from_float(obj.get("LeftHorizontalAbduction")),

            rightShoulderAbductionFlexion=from_float(obj.get("RightShoulderAbductionFlexion")),
            rightHorizontalAbduction=from_float(obj.get("RightHorizontalAbduction")),
            ...
            rightShoulderPos=toVector3(UnityVector3.from_dict(obj.get("RightShoulderPos"))),

            leftKnee=from_float(obj.get("LeftKnee")),
            leftPalm=toVector3(UnityVector3.from_dict(obj.get("LeftPalm"))),
            leftShoulderPos=toVector3(UnityVector3.from_dict(obj.get("LeftShoulderPos"))),
            ...
            # New fingertip positions
            leftThumbTip=toVector3(UnityVector3.from_dict(obj.get("LeftThumbTip"))),
            leftIndexTip=toVector3(UnityVector3.from_dict(obj.get("LeftIndexTip"))),
            leftMiddleTip=toVector3(UnityVector3.from_dict(obj.get("LeftMiddleTip"))),
            leftRingTip=toVector3(UnityVector3.from_dict(obj.get("LeftRingTip"))),
            leftPinkyTip=toVector3(UnityVector3.from_dict(obj.get("LeftPinkyTip"))),

            rightThumbTip=toVector3(UnityVector3.from_dict(obj.get("RightThumbTip"))),
            rightIndexTip=toVector3(UnityVector3.from_dict(obj.get("RightIndexTip"))),
            rightMiddleTip=toVector3(UnityVector3.from_dict(obj.get("RightMiddleTip"))),
            rightRingTip=toVector3(UnityVector3.from_dict(obj.get("RightRingTip"))),
            rightPinkyTip=toVector3(UnityVector3.from_dict(obj.get("RightPinkyTip"))),

            # New wrist positions
            leftWristPos=toVector3(UnityVector3.from_dict(obj.get("LeftWristPos"))),
            rightWristPos=toVector3(UnityVector3.from_dict(obj.get("RightWristPos"))),

            # New elbow positions
            leftElbowPos=toVector3(UnityVector3.from_dict(obj.get("LeftElbowPos"))),
            rightElbowPos=toVector3(UnityVector3.from_dict(obj.get("RightElbowPos"))),

            # New chest and headset positions
            chestPos=toVector3(UnityVector3.from_dict(obj.get("ChestPos"))),
            headsetPos=toVector3(UnityVector3.from_dict(obj.get("HeadsetPos"))),

            # New adjacent-finger angles (left hand)
            leftThumbIndexAngle=from_float(obj.get("LeftThumbIndexAngle")),
            leftIndexMiddleAngle=from_float(obj.get("LeftIndexMiddleAngle")),
            leftMiddleRingAngle=from_float(obj.get("LeftMiddleRingAngle")),
            leftRingPinkyAngle=from_float(obj.get("LeftRingPinkyAngle")),

            # New adjacent-finger angles (right hand)
            rightThumbIndexAngle=from_float(obj.get("RightThumbIndexAngle")),
            rightIndexMiddleAngle=from_float(obj.get("RightIndexMiddleAngle")),
            rightMiddleRingAngle=from_float(obj.get("RightMiddleRingAngle")),
            rightRingPinkyAngle=from_float(obj.get("RightRingPinkyAngle"))
        )
    ...
    def to_dict(self) -> dict:
        result = {
            ...
            # New fingertip positions
            "leftThumbTip": to_class(UnityVector3, self.leftThumbTip),
            "leftIndexTip": to_class(UnityVector3, self.leftIndexTip),
            "leftMiddleTip": to_class(UnityVector3, self.leftMiddleTip),
            "leftRingTip": to_class(UnityVector3, self.leftRingTip),
            "leftPinkyTip": to_class(UnityVector3, self.leftPinkyTip),

            "rightThumbTip": to_class(UnityVector3, self.rightThumbTip),
            "rightIndexTip": to_class(UnityVector3, self.rightIndexTip),
            "rightMiddleTip": to_class(UnityVector3, self.rightMiddleTip),
            "rightRingTip": to_class(UnityVector3, self.rightRingTip),
            "rightPinkyTip": to_class(UnityVector3, self.rightPinkyTip),

            # New wrist positions
            "leftWristPos": to_class(UnityVector3, self.leftWristPos),
            "rightWristPos": to_class(UnityVector3, self.rightWristPos),

            # New elbow positions
            "leftElbowPos": to_class(UnityVector3, self.leftElbowPos),
            "rightElbowPos": to_class(UnityVector3, self.rightElbowPos),

            # New chest and headset positions
            "chestPos": to_class(UnityVector3, self.chestPos),
            "headsetPos": to_class(UnityVector3, self.headsetPos),

            # New adjacent-finger angles (left hand)
            "leftThumbIndexAngle": to_float(self.leftThumbIndexAngle),
            "leftIndexMiddleAngle": to_float(self.leftIndexMiddleAngle),
            "leftMiddleRingAngle": to_float(self.leftMiddleRingAngle),
            "leftRingPinkyAngle": to_float(self.leftRingPinkyAngle),

            # New adjacent-finger angles (right hand)
            "rightThumbIndexAngle": to_float(self.rightThumbIndexAngle),
            "rightIndexMiddleAngle": to_float(self.rightIndexMiddleAngle),
            "rightMiddleRingAngle": to_float(self.rightMiddleRingAngle),
            "rightRingPinkyAngle": to_float(self.rightRingPinkyAngle)
        }
        return result
